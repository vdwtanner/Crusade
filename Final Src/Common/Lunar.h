...
//	Lunar is a c++ header that allows you to bind
//	and use c++ objects in lua code.
//	Code is taken from the website http://lua-users.org/wiki/CppBindingWithLunar
//	Cant find any copyright information on that site though.
